    ...
    render:function(){
        ...
        return (
            <g transform={transform}>
                <rect class="shadow" is width={width} height={height} rx="5" ry="5" visibility={visibility} fill={(this.props.tooltip.data.value > this.props.SLA[0].count) ? "#e54e16" :"#6391da"} opacity=".9"/>
                ...
                <text is visibility={visibility} transform={transformText}>
                    ...
                    <tspan is x="0" text-anchor="middle" dy="25" font-size="20px" fill={(this.props.tooltip.data.value > this.props.SLA[0].count) ? "#ffffff" :"#a9f3ff"}>{this.props.tooltip.data.value+":00"}</tspan>
                </text>
            </g>
        );
    }
            ...
            <div>
                <svg id={this.props.chartId} width={this.state.width} height={this.props.height}>
                    ...
                    <g transform={transform}>
                        ...
                        <ToolTip tooltip={this.state.tooltip} SLA={this.props.SLA}/>
                    </g>
